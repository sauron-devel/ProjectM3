...
def visualise_detections_only(image, detections, labels):
    for i in detections:
        ...
        image = cv2.putText(image, text, (i[0]+1,i[1]), cv2.FONT_HERSHEY_PLAIN, 0.3, (10,10,10), 1)
...
def visualise_trackers_only(image, tracked_dets, labels):
    for i in tracked_dets:
        ...
        image = cv2.putText(image, text, (i[0]+1,i[1]), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255,255,255), 1)
    return image
